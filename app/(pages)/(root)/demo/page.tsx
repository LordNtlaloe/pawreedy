                    ...
                    <div id="collapseMenu"
                        ...
                        <div
                            ...
                            <div className='flex items-center max-lg:flex-col-reverse max-lg:ml-auto gap-8'>
                                <div
                                    className='flex w-full bg-gray-100 px-4 py-2.5 rounded outline-none border focus-within:border-blue-600 focus-within:bg-transparent transition-all'>
                ...
                <div className="flex items-start">
                    <nav id="sidebar" className="lg:min-w-[250px] w-max max-lg:min-w-8">
                        <div id="sidebar-collapse-menu" 
                            ...
                            <div className="mt-6">
                                <h6 className="text-blue-600 text-sm font-bold px-4">General Settings</h6>
                                <ul className="mt-3 space-y-2">
                                    <li>
                                        <a href="javascript:void(0)"
                                            className="text-gray-800 text-sm flex items-center hover:bg-gray-100 rounded-md px-4 py-2 transition-all">
