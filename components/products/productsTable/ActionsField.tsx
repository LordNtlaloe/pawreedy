            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent className="bg-blue-950 text-white" align="end">
                    ...
                    {productActions.map((action) => (
                        <Link href={`/dashboard/productes?action=${action.label.toLocaleLowerCase()}&id=${id}`} key={action.id} className="border-b px-8 border-white/20 py-2 cursor-pointer hover:bg-gray-700 rounded mx-3 flex flex-col" onClick={() => {
